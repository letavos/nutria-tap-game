-- Script para atualizar dados do usuário com valores de exemplo
...
-- Atualizar a view de ranking (se for materialized view)
-- REFRESH MATERIALIZED VIEW public.ranking_view;

-- Ou se for uma view normal, não precisa de refresh
