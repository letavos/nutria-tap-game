...
const translations = {
  pt: {
    ...
    prestigeCompletedTitle: 'Prestígio Realizado!',
    newStart: 'Novo Começo',
    ...
    // Customization Panel (PT)
    personalization: 'Personalização',
    personalizationDesc: 'Personalize a aparência do seu jogo',
    circleColor: 'Cor do Círculo',
    chooseCircleColor: 'Escolha a cor do círculo do personagem',
    currentColor: 'Cor atual',
    borderStyle: 'Estilo de Borda',
    defineBorderStyle: 'Defina o estilo da borda do círculo',
    currentStyle: 'Estilo atual',
    backgroundStyle: 'Estilo de Fundo',
    chooseBackgroundStyle: 'Escolha o estilo de fundo do jogo',
    currentBackground: 'Fundo atual',
    visualEffects: 'Efeitos Visuais',
    addVisualEffects: 'Adicione efeitos especiais ao jogo',
    currentEffect: 'Efeito atual',
    
    // More Options
    moreOptions: 'Mais Opções',
    exploreFeatures: 'Explore todas as funcionalidades do jogo',
    badges: 'Emblemas',
    skins: 'Aparências',
    titles: 'Títulos',
    missions: 'Missões',
    ...
    aboutGameDesc: 'Nutria Tap é um jogo incremental onde você alimenta uma nutria para ganhar pontos.',
    version: 'Versão',
    developedBy: 'Desenvolvido com 💚 por Equipe Nutria',
    // Mini-games labels
    ...
    epic: 'Épico',
    legendary: 'Lendário',
    collectUnique: 'Colete pets, títulos, badges e skins únicos!',
    effect: 'Efeito',
    requirement: 'Requisito',
    achievementsRequirement: '{count}+ conquistas',
    clicksRequirement: '{count} cliques',
    pntrRequirement: '{amount} pNTR',
    streakRequirement: 'Streak de {count}',
    clickMaster: 'Mestre dos Cliques',
    youMasterClicking: 'Você domina a arte de clicar',
    effectClickBonus: '+5% pNTR por clique',
    prestigeLegend: 'Lenda do Prestígio',
    youTranscended: 'Você transcendeu o comum',
    effectPrestigeBonus: '+10% multiplicador de prestígio',
    nutriaEmperor: 'Imperador Nutria',
    highestTitle: 'O mais alto título possível',
    effectAllGains: '+25% todos os ganhos',
    youLoveCoins: 'Você ama juntar moedas',
    noOneKeepsStreak: 'Ninguém mantém streak como você',
    youCollectAchievements: 'Você coleciona conquistas',
    defaultSkin: 'Skin Padrão',
    classicAppearance: 'Aparência clássica',
    goldenSkin: 'Skin Dourada',
    shinesLikeGold: 'Brilha como ouro',
    levelRequirement: 'Nível {level}',
    neonSkin: 'Skin Neon',
    glowsInTheDark: 'Brilha no escuro',
    cosmicSkin: 'Skin Cósmica',
    fromDeepSpace: 'Das profundezas do espaço',
    ...
    eventsHeaderDesc: 'Eventos especiais e conquistas sazonais',
    howEventsWork: 'Como funcionam os eventos?',
    permanentEvents: 'Eventos Permanentes',
    permanentEventsDesc: 'Sempre disponíveis para desbloqueio',
    seasonalEvents: 'Eventos Sazonais',
    seasonalEventsDesc: 'Disponíveis apenas durante períodos específicos',
    ...
    verificationEmailResent: 'Email de verificação reenviado! Verifique sua caixa de entrada.',
    emailVerifiedTitle: 'Email Verificado!',
    emailVerifiedMessage: 'Seu email foi verificado com sucesso. Você pode continuar usando o jogo.',
    emailVerificationRequired: 'Verificação de Email Necessária',
    emailVerificationInfo: 'Para continuar, você precisa verificar seu email.',
    ...
    ensureEmailCorrect: 'Certifique-se de que o email está correto',
    linkMayExpire: 'O link pode ter expirado - reenvie um novo',
    ifProblemPersists: 'Se o problema persistir, tente criar uma nova conta',
    ...
    greenOrangeGradient: 'Gradiente Verde-Laranja',
    bluePurpleGradient: 'Gradiente Azul-Roxo',
  ...
  en: {
    ...
    prestigeCompletedTitle: 'Prestige Completed!',
    newStart: 'New Start',
    ...
    exploreFeatures: 'Explore all game features',
    badges: 'Badges',
    skins: 'Skins',
    titles: 'Titles',
    missions: 'Missions',
    ...
    aboutGameDesc: 'Nutria Tap is an incremental game where you feed a nutria to earn points.',
    version: 'Version',
    developedBy: 'Developed with 💚 by Nutria Team',
    // Mini-games labels
    nutriaTarget: 'Nutria Target',
    ...
    epic: 'Epic',
    legendary: 'Legendary',
    collectUnique: 'Collect unique pets, titles, badges and skins!',
    effect: 'Effect',
    requirement: 'Requirement',
    achievementsRequirement: '{count}+ achievements',
    clicksRequirement: '{count} clicks',
    pntrRequirement: '{amount} pNTR',
    streakRequirement: '{count} streak',
    clickMaster: 'Click Master',
    youMasterClicking: 'You master the art of clicking',
    effectClickBonus: '+5% pNTR per click',
    prestigeLegend: 'Prestige Legend',
    youTranscended: 'You transcended the ordinary',
    effectPrestigeBonus: '+10% prestige multiplier',
    nutriaEmperor: 'Nutria Emperor',
    highestTitle: 'The highest possible title',
    effectAllGains: '+25% all gains',
    youLoveCoins: 'You love collecting coins',
    noOneKeepsStreak: 'No one keeps streaks like you',
    youCollectAchievements: 'You collect achievements',
    defaultSkin: 'Default Skin',
    classicAppearance: 'Classic appearance',
    goldenSkin: 'Golden Skin',
    shinesLikeGold: 'Shines like gold',
    levelRequirement: 'Level {level}',
    neonSkin: 'Neon Skin',
    glowsInTheDark: 'Glows in the dark',
    cosmicSkin: 'Cosmic Skin',
    fromDeepSpace: 'From the depths of space',
    ...
    eventsHeaderDesc: 'Special events and seasonal achievements',
    howEventsWork: 'How do events work?',
    permanentEvents: 'Permanent Events',
    permanentEventsDesc: 'Always available to unlock',
    seasonalEvents: 'Seasonal Events',
    seasonalEventsDesc: 'Available only during specific periods',
    ...
    addVisualEffects: 'Adicione efeitos especiais ao jogo',
    currentEffect: 'Efeito atual',
    borderStaticDesc: 'Borda sólida e estática',
    borderPulseDesc: 'Borda com efeito pulsante',
    borderGlowDesc: 'Borda com brilho suave',
    borderGradientDesc: 'Borda com gradiente colorido',
    backgroundDefaultDesc: 'Fundo padrão do jogo',
    backgroundGradient1Desc: 'Gradiente verde e dourado',
    backgroundGradient2Desc: 'Gradiente azul e roxo',
    backgroundGradient3Desc: 'Gradiente neon vibrante',
    effectNoneDesc: 'Sem efeitos especiais',
    effectShineDesc: 'Efeito de brilho suave',
    effectParticlesDesc: 'Partículas flutuantes',
    // Customization Panel
    personalization: 'Personalization',
    personalizationDesc: 'Customize your game appearance',
    circleColor: 'Circle Color',
    chooseCircleColor: 'Choose the character circle color',
    currentColor: 'Current color',
    borderStyle: 'Border Style',
    defineBorderStyle: 'Define the circle border style',
    currentStyle: 'Current style',
    backgroundStyle: 'Background Style',
    chooseBackgroundStyle: 'Choose the game background style',
    currentBackground: 'Current background',
    visualEffects: 'Visual Effects',
    addVisualEffects: 'Add special effects to the game',
    currentEffect: 'Current effect',
    borderStaticDesc: 'Solid static border',
    borderPulseDesc: 'Pulsing border',
    borderGlowDesc: 'Soft glow border',
    borderGradientDesc: 'Color gradient border',
    backgroundDefaultDesc: 'Default game background',
    backgroundGradient1Desc: 'Green-gold gradient',
    backgroundGradient2Desc: 'Blue-purple gradient',
    backgroundGradient3Desc: 'Vibrant neon gradient',
    effectNoneDesc: 'No special effects',
    effectShineDesc: 'Soft shine effect',
    effectParticlesDesc: 'Floating particles',
    sending: 'Sending...',
    emailAlreadyVerified: 'Email already verified!',
    pleaseEnterEmail: 'Please enter your email',
    verificationEmailResent: 'Verification email resent! Check your inbox.',
    emailVerifiedTitle: 'Email Verified!',
    emailVerifiedMessage: 'Your email was verified. You can continue using the game.',
    emailVerificationRequired: 'Email Verification Required',
    emailVerificationInfo: 'To continue, you need to verify your email.',
    resendVerificationEmail: 'Resend Verification Email',
    commonProblems: 'Common problems:',
    checkSpam: 'Check your spam folder',
    ensureEmailCorrect: 'Make sure the email is correct',
    linkMayExpire: 'The link may have expired - resend a new one',
    ifProblemPersists: 'If the problem persists, try creating a new account',
    ...
    greenOrangeGradient: 'Green-Orange Gradient',
